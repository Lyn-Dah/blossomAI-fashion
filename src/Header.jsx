    ...
    <header className="bg-gradient-to-r from-green-950 to-current#c9c04d  text-white shadow-lg fixed w-full z-50 top-0 py-2 px-2">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="block lg:hidden">
          ...
          <svg className="w-6 h-6" fill="none" stroke="#34C759" strokeWidth="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <path strokeLinecap="round" strokeLinejoin="round" d={isOpen ? "M6 18L18 6M6 6l12 12" : "M4 6h16M4 12h16m-7 6h7"}></path>
  </svg>
